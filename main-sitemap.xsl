			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Standorte-Sitemap - psvisual</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML-Sitemap - psvisual</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://fachinformatiker.github.io/wordpress_test/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
